<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Generate.aspx.cs" Inherits="Project.Generate" %>
        ...
        <script type="text/javascript">
            function ch1() {
                ...
                if (checkBox.checked)
                {
                    ...
                    document.getElementById("txtset").value = details;
                    document.getElementById("lbtl").innerHTML = "";
            ...
            function ch2() {
                ...
                if (checkBox.checked) {
                    ...
                    document.getElementById("txtset").value = details;
                    document.getElementById("lbsubtl").innerHTML = "";
            ...
            function ch3() {
                ...
                if (checkBox.checked) {
                    ...
                    document.getElementById("txtset").value = details;
                    document.getElementById("lboname").innerHTML = "";
            ...
            function ch5() {
                ...
                if (checkBox.checked) {
                    document.getElementById("txtset").value = "";
    ...
    <script type="text/javascript">  
        function takeScreenshot() {
            html2canvas(document.getElementById('templateDiv')).then(function (canvas) {
                ...
                const date = new Date();
                document.getElementById("hdfimage").value = date;
        ...
        <div  class="row" style="width:100%">
            ...
            <div  style="height:700px;margin-top:0px;margin-left:2px" id="contentDiv" runat="server">
                ...
                <div style="border: none;position: absolute;z-index: 9;margin: 1%;background-color:white" >
                    <div>
                      <asp:Label ID="lbcerno" runat="server" Font-Size="15px" Font-Bold="true"  ForeColor="black"  Text=" Certificate No. : " style="font-family:'Times New Roman'" ></asp:Label>
                    </div>           
                </div><br /><br /><br /><br />
                <div style="border: none;" id="onmdiv">
                    <div id="onmdivheader">
                      <asp:Label ID="lboname" runat="server" Font-Size="25px" ForeColor="black"  Text="Organization Name" style="font-family:'Times New Roman'" ></asp:Label>
                    </div>           
                </div><br /><br /><br /><br />
                <div style="border: none;" id="tldiv" >
                    <div id="tldivheader">
                      <asp:Label ID="lbtl" runat="server" Font-Size="60px" ForeColor="DarkGoldenrod" Text="Certificate Of Appreciation" style="font-family:'Old English Text MT';"  ></asp:Label>
                    </div>           
                </div><br /><br /><br /><br /><br />              
                <div style="border: none;" id="stldiv" >
                    <div id="stldivheader">
                      <asp:Label ID="lbsubtl" runat="server" Font-Size="25px" ForeColor="black"  Text="is proudly Presented to :" style="font-family:'Times New Roman'" ></asp:Label>
                    </div>           
                </div><br /><br /><br /><br />
                <div style="border: none;" id="nmlndiv" >
                    <div id="nmlndivheader" style="border-bottom:1px solid black">  
                        <asp:Label ID="lb" runat="server" Font-Size="25px" ForeColor="black"  Text="Mr. / Miss     " style="font-family:'Times New Roman'"></asp:Label>
                        <asp:Label ID="lbname" runat="server" Font-Size="25px" ForeColor="black"  Text="Name" style="font-family:'Times New Roman'"></asp:Label>
                    </div>
                </div><br /><br />
                <div style="border: none;" id="descdiv">
                    <div id="descdivheader" >
                      <asp:Label ID="lbdesc" runat="server" Font-Size="20px" ForeColor="DarkSlateGray" Text="in appreciation of their service and contribution to Organization/Institute. Your Dedication, hardwork and generosity have made a significant impact, andd we are greatful for your support." style="font-family:'Times New Roman';"  ></asp:Label>
                    </div>           
                </div>
               </div>
            </div>
            <div class="col-lg-4" style="background-color: aliceblue;">                
                ...
                <br />
                <div class="row">
                    <button type="button" id="btndownload" class="btn btn-primary btn-lg btn-block" onclick="takeScreenshot()">Download</button>
                </div>
                <br />
                <div id="doneDiv" class="row" style="display:none">                    
                    <asp:LinkButton ID="lbtnfinish" runat="server" CssClass="btn btn-success btn-lg btn-block" OnClick="lbtnfinish_Click" data-toggle="tooltip" title="Click Me!">Finish</asp:LinkButton>                   
                </div>
            </div>
